...
class ReportPayload(StrictModel):
    ...
    finding_workflow_summary: dict[str, int] = Field(default_factory=dict)
    finding_actions: list[dict[str, Any]] = Field(default_factory=list)
...
def build_external_report_payload(
    ...
    *,
    ...
    generated_at: str | None = None,
    executor: str = "system",
    finding_workflow_summary: dict[str, int] | None = None,
    finding_actions: list[dict[str, Any]] | None = None,
) -> ReportPayload:
    ...
    return ReportPayload(
        ...
        finding_workflow_summary=finding_workflow_summary or {},
        finding_actions=finding_actions or [],
