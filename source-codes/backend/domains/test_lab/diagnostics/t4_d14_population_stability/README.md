# T4-D14 Population Stability Index (PSI)

This package owns the governed PSI workflow, including population selection, arithmetic,
manifest orchestration, and execution. It consumes shared Test Lab binning primitives and
governed evidence produced by T1-D02 Single-feature Target Separation. Compatibility aliases
preserve the former `dq_diagnostics` module paths without duplicating implementation.
