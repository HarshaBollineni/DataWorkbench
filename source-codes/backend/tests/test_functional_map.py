...
SHEET_SOURCES = {
    ...
    "diagnostics-core": [
        ...
        "dq_diagnostics/manifest.py", "dq_diagnostics/readiness.py", "dq_diagnostics/result.py",
        "dq_diagnostics/thresholds.py", "dq_diagnostics/delivery.py",
        "dq_diagnostics/profiling_preconditions.py",
    ],
    "diagnostics-engines": [
        "dq_diagnostics/engines/base.py", "dq_diagnostics/engines/cross_field/binder.py",
        "dq_diagnostics/engines/cross_field/engine.py", "dq_diagnostics/engines/cross_field/primitives.py",
        "dq_diagnostics/engines/cross_field/result.py", "dq_diagnostics/engines/cross_field/roles.py",
        "dq_diagnostics/engines/cross_field/rules.py",
    ],
