...
import { FindingStateBadge, FindingStatusCards, IssueLifecycleActions } from "@/pages/testlab/FindingWorkflow";
...
export default function CrossFieldResults({ results = [], onDisposition, onPromote, onCloseIssue, onRecompute, loading, error }) {
  const [workflowFilter, setWorkflowFilter] = useState("all");
  const selectWorkflowFilter = (nextFilter) => setWorkflowFilter(nextFilter);
